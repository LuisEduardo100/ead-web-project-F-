            ...
            <section className="bg-gray-50 flex-grow py-6">
                <div className="max-w-2xl mx-auto px-3">
                    <div className="bg-white rounded-lg shadow-md p-6">
                        <h1 className="text-2xl font-bold text-gray-800 mb-6">Criar sua conta</h1>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div>
                                <label htmlFor="birth" className="block text-sm font-medium text-gray-700">Data de Nascimento</label>
                                <input
                                    type="date"
                                    id="birth"
                                    name="birth"
